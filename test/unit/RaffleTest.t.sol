...
contract RaffleTest is Test, CodeConstants {
    ...
    function setUp() external {
        ...
        if (block.chainid == LOCAL_CHAIN_ID && subscriptionId != 0) {
    ...
    function testCUKReturnsFalseIfEnoughTimeNotPass() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: raffleEntranceFee}();
    ...
    function testCUKReturnsTrueWhenParametersGood() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: raffleEntranceFee}();
        vm.warp(block.timestamp + automationUpdateInterval + 1);
